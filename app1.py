...
#     target_language = st.selectbox("Select Target Language", ["German", "French", "Chinese", "Japanese"])
...
#     # Display original content in the left column
#     content_col1, content_col2 = st.columns(2)

#     with content_col1:
#         st.subheader("Original Content")
#         st.markdown(f"""
#             <div style="height: 500px; overflow-y: scroll; font-size: 16px; line-height: 1.5; border: 1px solid #ccc; padding: 10px; margin-bottom: 20px;">
...
#         # Translate button below the heading
#         translate_button = st.button("Translate")
#         if translate_button:
#             with st.spinner("Translating..."):
#                 # Translate the content while preserving Markdown
#                 translated_text = translate_content(content, target_language)
#                 st.markdown(f"""
#                     <div style="height: 500px; overflow-y: scroll; font-size: 16px; line-height: 1.5; border: 1px solid #ccc; padding: 10px; margin-bottom: 20px;">
#                         {markdown2.markdown(translated_text)}
#                     </div>
#                 """, unsafe_allow_html=True)
...
#     allowed_tags = bleach.sanitizer.ALLOWED_TAGS + ['b', 'i', 'u', 'span', 'hr']  # Allow additional tags
...
# # Function to sanitize HTML content
# def sanitize_html(content):
#     # Convert frozenset to list and then add custom allowed tags
#     allowed_tags = list(bleach.sanitizer.ALLOWED_TAGS) + ['b', 'i', 'u', 'span', 'hr']  # Allow additional tags
#     allowed_attrs = {'span': ['style']}  # Allow style attributes on span tags
#     return bleach.clean(content, tags=allowed_tags, attributes=allowed_attrs)
